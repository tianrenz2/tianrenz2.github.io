...
## Privacy Policy
<p>StarGazers Studio built the Star Gazing app as a free game. This SERVICE is provided by Star Gazers and is intended
    for use as is.</p>
...
<p>For a better experience while using our Service, [I|we] may require you to provide certain
    personally identifiable information, including but not limited to user name.
	The information that we request is [retained on your device and is not
    collected by [me|us] in any way]|[will be retained by [me|us] and used as described in this privacy policy.</p>
